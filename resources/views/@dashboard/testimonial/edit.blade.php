...
@section('page_contents')
    ...
    <!-- Page Forms -->
    <form action="{{ route('testimonial.update', $resource->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Edit '{{ getFromJson($resource->name , lang()) }}' testimonial</h6>
            </div>
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('role_'.$lang) is-invalid @enderror "
                                       ...
                                       placeholder="Enter role_ {{ $lang }} .." value="{{ getFromJson($resource->role , $lang) }}">
