...
{{--            <img class="d-block w-100" src="{{ url('assets_public/images/slider/'.$slider->image) }}" alt="{{ getFromJson($slider->text_1 , lang()) }}">--}}

{{--            <div class="carousel-caption d-none d-md-block">--}}
{{--                <h5>{{ getFromJson($slider->text_1 , lang()) }}</h5>--}}
{{--                <p>{!! getFromJson($slider->text_2 , lang()) !!}</p>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--        @endforeach--}}
{{--    </div>--}}
